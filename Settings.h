...
class Settings 
{
  ...
  //These were moved here from IceModel under the new compilation scheme
        ...
        //42: UNL Modified (PA model) with downward systeamtics. Related slide: https://aradocs.wipac.wisc.edu/0035/003525/002/5SA_Ice_Model_Uncertainties.pdf
	...
	//        int EVENT_NUM;//number of events to read in, using EVENT_GENERATION_MODE=1, default initial 0: read in the number of events in the input file, resets to total number of events read in
        ...
        int ELECTRONICS_ANTENNA_CONSISTENCY; // 0: use electronics gain amplitude read-in from file
                                             // 1: calculate electronics gain amplitude directly from noise model & antenna gain (guarantees
                                             //    the antenna gain used in calculating electronics gain is consistent with that used in 
                                             //    this simulation)
